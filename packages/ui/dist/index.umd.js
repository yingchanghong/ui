(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Tests = {}, global.vue));
      ...
      setup(__props) {
          ...
          return (_ctx, _cache) => {
              return (vue.openBlock(), vue.createElementBlock("button", {
                  class: vue.normalizeClass(["y-button", [vue.unref(classes), vue.unref(size), vue.unref(isDisabled)]]),
  ...
  var script$8 = /*#__PURE__*/ vue.defineComponent({
      ...
      setup(__props) {
          ...
          const messageStyle = vue.computed(() => `y-message--${props.type}`);
          const close = () => {
              visible.value = false;
              setTimeout(() => {
              ...
              return (vue.openBlock(), vue.createBlock(vue.Transition, {
                  ...
                  default: vue.withCtx(() => [
                      vue.withDirectives(vue.createElementVNode("div", {
                          class: vue.normalizeClass(["y-message", vue.unref(messageStyle)]),
                          style: vue.normalizeStyle({ top: `${__props.top}px` })
                      }, [
      ...
      setup(__props) {
          return (_ctx, _cache) => {
              return (vue.openBlock(), vue.createElementBlock("table", {
                  class: vue.normalizeClass(['y-table', __props.border ? 'y-table-border' : 'y-table-bottom']),
                  cellpadding: "0",
                  cellspacing: "0"
              }, [
                      ...
                      vue.createElementVNode("tr", null, [
                          ...
                          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.columns, (item) => {
                              return (vue.openBlock(), vue.createElementBlock("th", {
                                  key: item.key
                              }, vue.toDisplayString(item.title), 1 /* TEXT */));
                          }), 128 /* KEYED_FRAGMENT */))
                      ])
                  ]),
                  vue.createElementVNode("tbody", _hoisted_3$2, [
                      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.dataSource, (dataItem, dataIndex) => {
                          return (vue.openBlock(), vue.createElementBlock("tr", {
                              key: dataIndex,
                              class: vue.normalizeClass(__props.stripe ? 'y-table-stripe' : '')
                          }, [
                              (__props.showNum)
                                  ? (vue.openBlock(), vue.createElementBlock("td", _hoisted_4$1, vue.toDisplayString(dataIndex + 1), 1 /* TEXT */))
                                  : vue.createCommentVNode("v-if", true),
                              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.columns, (columnItem) => {
                                  return (vue.openBlock(), vue.createElementBlock("td", {
                                      key: columnItem.key
                                  }, [
                                      (!columnItem.slots)
                                          ? vue.renderSlot(_ctx.$slots, "default", { key: 0 }, () => [
                                              vue.createTextVNode(vue.toDisplayString(dataItem[columnItem.key]), 1 /* TEXT */)
                                          ])
                                          : vue.renderSlot(_ctx.$slots, columnItem.slots, {
                                              key: 1,
                                              rowData: dataItem
                                          })
                                  ]));
